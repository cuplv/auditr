...
//  #define BASE	  2166136261 (unsigned int not supported in Java)
...
void printHelp () {
  ...
  printf("  -n      number of characters (default: 3)\n");
  printf("  -b      base number for hash function (default: 0)\n");
  printf("  -p      factor (typically prime) for hash function (default: 31)\n");
  exit(0); }
