HashClash is a generator of strings that have
...
programs:
- hashclash.c : given a hash function and a 
  hash value, hashclash will produce a SAT 
...
After installation, HashClash can be tested
